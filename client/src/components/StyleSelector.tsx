  ...
  return (
    <div className="relative space-y-3">
      ...
      <button
        ...
        className="flex w-full items-center justify-between rounded-md border px-4 py-3 text-left bg-white/10 border-white/10 text-zinc-200 transition hover:bg-white/15"
      >
