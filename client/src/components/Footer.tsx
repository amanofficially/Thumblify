      ...
      >
        ...
        <div className="flex items-center gap-4 mt-3">
          <a href="#" target="_blank" rel="noreferrer">
            <DribbbleIcon className="size-5 cursor-pointer hover:text-pink-500" />
          </a>
          <a href="#" target="_blank" rel="noreferrer">
            <LinkedinIcon className="size-5 cursor-pointer hover:text-pink-500" />
          </a>
          <a href="#" target="_blank" rel="noreferrer">
            <TwitterIcon className="size-5 cursor-pointer hover:text-pink-500" />
          </a>
          <a href="#" target="_blank" rel="noreferrer">
            <YoutubeIcon className="size-6 cursor-pointer hover:text-pink-500" />
          </a>
        </div>
