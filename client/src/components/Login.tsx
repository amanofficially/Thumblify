    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center px-4 sm:px-0">
        <form onSubmit={handleSubmit} className="w-full sm:w-87.5 text-center bg-white/6 border border-white/10 rounded-2xl px-6 sm:px-8">
          ...
          {error && (
            <p className="mt-4 text-sm text-red-400 bg-red-400/10 rounded-lg px-3 py-2">{error}</p>
          )}
          ...
          <button type="submit" disabled={loading} className="mt-6 w-full h-11 rounded-full text-white bg-pink-600 hover:bg-pink-500 disabled:opacity-60 disabled:cursor-not-allowed transition">
