          ...
          <div className="group relative h-full w-full">
            ...
            <div className="absolute inset-0 flex items-end justify-center bg-black/10 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
              <button
                onClick={onDownload}
                type="button"
                className="mb-6 flex items-center gap-2 rounded-xl bg-white/30 px-5 py-2.5 text-sm font-medium text-white ring-1 ring-white/40 backdrop-blur-md transition hover:scale-105 active:scale-95"
              >
